...
# Info
UPGRADE_NAME="v1800alpha2" # upgradehandler
UPGRADE_HUMAN_NAME="Alpha2-Patch"
FEES="500000$DENOM" # 0.5


TITLE="Juno Upgrade: $UPGRADE_HUMAN_NAME ($UPGRADE_NAME)"
DESC="# Juno Epona Upgrade (v18)\n\n[Release Notes](https://github.com/CosmosContracts/juno/releases/tag/v18.0.0-alpha.2)\n\n---\n\n\n## Voting Options\nYES: Agree to proceed with the v18 network upgrade.\nNO: Disagree with the v18 network upgrade."
UPGRADE_INFO='{"binaries":{"linux/amd64":"https://github.com/CosmosContracts/juno/releases/download/v18.0.0-alpha.2/junod"}}'
