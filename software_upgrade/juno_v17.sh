...
# UPGRADE_HEIGHT="9481382"  # https://www.mintscan.io/juno/blocks/9481382
...
DESC="# Juno Vesta Upgrade (v17)\n\nhttps://github.com/CosmosContracts/juno/releases/tag/v17.0.0-alpha.1\n\n"
UPGRADE_INFO='{"binaries":{"linux/amd64":"https://github.com/CosmosContracts/juno/releases/download/v17.0.0-alpha.1/junod"}}'
